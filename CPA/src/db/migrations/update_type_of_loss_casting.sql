-- Migration to update the create_claim_with_vehicle function to properly cast type_of_loss
-- This addresses the type mismatch error when creating claims with type_of_loss values

-- Update the create_claim_with_vehicle function to properly cast the type_of_loss value
...
'Creates a vehicle and claim in a single transaction, ensuring atomicity and preventing job number collisions. Properly validates and casts the instruction, time_of_loss, and type_of_loss values to their respective types.';
