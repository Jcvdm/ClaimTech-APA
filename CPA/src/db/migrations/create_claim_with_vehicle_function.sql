-- Migration to create a function that handles claim and vehicle creation in a single transaction
-- This addresses the race condition in job number generation and prevents orphaned vehicles
...
'Creates a vehicle and claim in a single transaction, ensuring atomicity and preventing job number collisions.';
